...
const handler = createMcpHandler(
  ...
  },
  {
    capabilities: {
      tools: {
        sequential_thinking: { description: 'Dynamic problem-solving through structured thinking' },
        get_thinking_summary: { description: 'Get session summary' },
        list_thinking_sessions: { description: 'List all sessions' },
        switch_thinking_branch: { description: 'Switch thinking branch' },
        complete_thinking_session: { description: 'Complete session' },
      },
    },
  }
);
